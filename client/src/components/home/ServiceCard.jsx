...
const ServiceCard = ({ service, delay, layout }) => {
  if (layout === 'horizontal') {
    return (
      <div className="service-h">
        <div className="service-h__left">
          <div className="service-h__icon" dangerouslySetInnerHTML={{ __html: service.iconSvg }} />
          <h3>{service.title}</h3>
          <p className="service-h__desc">{service.description}</p>
        ...
        <div className="service-h__right">
